export { default as About } from 'features/pages/About/About';
export { default as Error } from 'features/pages/Error/Error';
...
export { default as Search } from 'features/pages/Search/Search';
